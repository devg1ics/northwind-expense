              ...
              <div key={i} className={`flex gap-3 ${msg.role==='user' ? 'justify-end' : 'justify-start'} fade-in`}>
                ...
                <div className={`max-w-xl flex flex-col gap-2 ${msg.role==='user'?'items-end':''}`}>
                  {msg.role === 'user' ? (
                    ...
                    <div className="rounded-2xl rounded-tl-sm border border-amber-200 bg-amber-50 overflow-hidden">
                      ...
                      {msg.citations?.length > 0 && (
                        <div className="border-t border-amber-200 px-4 py-3 bg-amber-50/60">
                          <p className="text-[10px] font-semibold text-amber-600 uppercase tracking-wider mb-2">Most relevant policies found</p>
                  ...
                  {!msg.refused && !msg.out_of_scope && msg.citations?.length > 0 && (
